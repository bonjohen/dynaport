...
This module provides framework-agnostic functionality for detecting available ports,
...
class PortAllocator:
    ...
    to applications, and persistence of port assignments. It is completely
    framework-agnostic and can be used with any type of application.
    """
